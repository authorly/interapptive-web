class Scene < ActiveRecord::Base
  ...
  def create_main_menu_widgets
    ...
    self.widgets = [
      {type: 'ButtonWidget', id: 2, scale: {horizontal: 100, vertical: 100}, position: {x:512, y:200}, name: 'read_it_myself', z_order: 4001 },
      {type: 'ButtonWidget', id: 3, scale: {horizontal: 100, vertical: 100}, position: {x:177, y:200}, name: 'read_to_me',     z_order: 4002 },
      {type: 'ButtonWidget', id: 4, scale: {horizontal: 100, vertical: 100}, position: {x:844, y:200}, name: 'auto_play',      z_order: 4003 },
    ]
  end
