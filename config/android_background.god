...
NUM_WORKERS.times do |num|
  God.watch do |w|
    ...
    w.env             = { "QUEUE" => "mailer,storybook_archive,subscription_publication,android_compilation,auto_alignment", "RAILS_ENV" => RAILS_ENV, 'VERBOSE' => 'true', "PIDFILE" => "#{SHARED_PATH}/pids/#{w.name}.pid" }
